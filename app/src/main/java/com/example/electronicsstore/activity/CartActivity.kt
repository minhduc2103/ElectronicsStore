...
import com.example.electronicsstore.adapter.CartAdapter
import com.example.electronicsstore.adapter.CartAdapter.IClickCartListener
import com.example.electronicsstore.database.ProductDatabase.Companion.getInstance
import com.example.electronicsstore.event.AddressSelectedEvent
import com.example.electronicsstore.event.DisplayCartEvent
import com.example.electronicsstore.event.OrderSuccessEvent
import com.example.electronicsstore.event.PaymentMethodSelectedEvent
import com.example.electronicsstore.event.VoucherSelectedEvent
import com.example.electronicsstore.model.Address
import com.example.electronicsstore.model.Order
import com.example.electronicsstore.model.PaymentMethod
import com.example.electronicsstore.model.Product
import com.example.electronicsstore.model.ProductOrder
    ...
    private fun initData() {
        ...
        cartAdapter = CartAdapter(listProductCart, object : IClickCartListener {
            override fun onClickDeleteItem(product: Product?, position: Int) {
                getInstance(this@CartActivity)!!.productDAO()!!
