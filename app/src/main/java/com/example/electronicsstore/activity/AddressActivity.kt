...
import com.example.electronicsstore.adapter.AddressAdapter
import com.example.electronicsstore.adapter.AddressAdapter.IClickAddressListener
...
import com.example.electronicsstore.utils.GlobalFunction.showToastMessage
        ...
        addressAdapter = AddressAdapter(
            ...
            object : IClickAddressListener {
                override fun onClickAddressItem(address: Address?) {
                    address?.let { handleClickAddress(it) }
                }
            })
